...
const STORAGE_KEY_BROWSER_MODEL = 'si-ai-flow-browser-model';
const STORAGE_KEY_CLOUD_LLM = 'si-ai-flow-cloud-llm';
const STORAGE_KEY_MAP_NEWS_FLASH = 'si-map-news-flash';
const STORAGE_KEY_HEADLINE_MEMORY = 'si-headline-memory';
const STORAGE_KEY_BADGE_ANIMATION = 'si-badge-animation';
const STORAGE_KEY_STREAM_QUALITY = 'si-stream-quality';

...
export const RUNTIME_FEATURES: RuntimeFeatureDefinition[] = [
  {
    ...
    fallback: 'Disabled by default for MVP. Enable only with paid fallback flag; otherwise OpenRouter free then local browser model.',
  },
  {
    id: 'aiGroq',
    name: 'Groq summarization',
    description: 'Optional paid fallback provider for AI summary generation.',
    requiredSecrets: ['GROQ_API_KEY'],
    fallback: 'Disabled by default for MVP. OpenRouter free is the default cloud provider.',
  },
  {
    id: 'aiOpenRouter',
    name: 'OpenRouter summarization',
    description: 'Default cloud LLM provider for AI summary and analyst synthesis. The server forces OpenRouter free models by default.',
    requiredSecrets: ['OPENROUTER_API_KEY'],
    fallback: 'Falls back to local browser model unless paid fallback flag is explicitly enabled.',
  },
  {
    id: 'aiOpenAI',

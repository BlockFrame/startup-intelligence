...
const STORAGE_KEY = 'si-globe-render-scale';
const EVENT_NAME = 'si-globe-render-scale-changed';

const TEXTURE_STORAGE_KEY = 'si-globe-texture';
const TEXTURE_EVENT_NAME = 'si-globe-texture-changed';
...
const PRESET_STORAGE_KEY = 'si-globe-visual-preset';
const PRESET_EVENT_NAME = 'si-globe-visual-preset-changed';

...
export const VARIANT_META: { startup: VariantMeta; [k: string]: VariantMeta } = {
  ...
  startup: {
    title: 'Startup Intelligence - VC Dealflow, Market Signals & Founder Radar',
    description: 'Startup intelligence dashboard for VC and investors tracking funding rounds, startup ecosystems, unicorns, accelerators, AI labs, market comps, and emerging sector signals.',
    keywords: 'startup intelligence, venture capital dashboard, VC dealflow, funding rounds, startup ecosystem, unicorn tracker, accelerator tracking, startup news, AI startups, fintech startups, market comps, founder radar, investment research',
    url: 'https://startupintelligence.app/',
    siteName: 'Startup Intelligence',
    shortName: 'StartupIntel',
    subject: 'Startup, Venture Capital, and Private Market Intelligence',
    classification: 'Startup Intelligence Dashboard, VC Research Tool, Dealflow Monitor',

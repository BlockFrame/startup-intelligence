...
export const VARIANT_META: { startup: VariantMeta; [k: string]: VariantMeta } = {
  full: {
    title: 'Startup Intelligence - Real-Time Global Intelligence Dashboard',
    ...
    url: 'https://startupintelligence.app/',
    siteName: 'Startup Intelligence',
    shortName: 'Startup Intelligence',
  ...
  startup: {
    title: 'AI Startup Intelligence - VC Dealflow, Market Signals & Founder Radar',
    description: 'AI Startup Intelligence dashboard for VC and investors tracking funding rounds, startup ecosystems, unicorns, accelerators, AI labs, market comps, and emerging sector signals.',
    keywords: 'AI startup intelligence, startup intelligence, venture capital dashboard, VC dealflow, funding rounds, startup ecosystem, unicorn tracker, accelerator tracking, startup news, AI startups, fintech startups, market comps, founder radar, investment research',
    url: 'https://startupintelligence.app/',
    siteName: 'AI Startup Intelligence',
    shortName: 'AI Startup Intel',
    subject: 'Startup, Venture Capital, and Private Market Intelligence',
    classification: 'AI Startup Intelligence Dashboard, VC Research Tool, Dealflow Monitor',
    ...
    features: [
      ...
      'Startup ecosystem mapping',
      'Unicorn tracking',
      'Accelerator and demo day tracking',
      'VC essay and thesis monitoring',
      'Product launch discovery',
      'AI and fintech sector signals',
      'Public market comps',

...
function isStartupPopupType(type: PopupType): boolean {
...
export class MapPopup {
  ...
  private renderContent(data: PopupData): string {
    if (isStartupPopupType(data.type)) {
      return renderStartupMapPopup(data.type as StartupPopupType, data.data as never);
    }

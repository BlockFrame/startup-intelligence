...
export const VARIANT_FEEDS: Record<string, Record<string, ServerFeed[]>> = {
  ...
  tech: {
    ...
    ai: [
      ...
      { name: 'Google AI', url: gn('site:blog.google/technology/ai OR site:deepmind.google when:7d') },
      { name: 'Microsoft AI', url: gn('site:blogs.microsoft.com/ai OR site:microsoft.com/en-us/ai when:7d') },
      { name: 'Meta AI', url: gn('site:ai.meta.com/blog OR "Meta AI" model when:7d') },
      { name: 'NVIDIA AI', url: gn('site:blogs.nvidia.com AI OR NVIDIA AI model when:7d') },
      { name: 'Hugging Face Blog', url: 'https://huggingface.co/blog/feed.xml' },
      { name: 'Mistral AI', url: gn('site:mistral.ai AI model OR "Mistral AI" when:7d') },
      { name: 'Cohere AI', url: gn('site:cohere.com AI model OR "Cohere" LLM when:7d') },
      { name: 'AI Engineering', url: gn('("AI agent" OR RAG OR "LLM gateway" OR "AI eval" OR "model context protocol") when:3d') },
      { name: 'ArXiv AI', url: 'https://export.arxiv.org/rss/cs.AI' },
      { name: 'ArXiv ML', url: 'https://export.arxiv.org/rss/cs.LG' },
      { name: 'AI Weekly', url: gn('"artificial intelligence" OR "machine learning" when:3d') },

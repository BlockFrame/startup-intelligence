/**
 * Builds compact StartupIntelligence-ready snapshot payloads from computed indices.
 * All types are shaped to match the proto-generated TypeScript interfaces so
 * snapshots can be written to Redis and read directly by StartupIntelligence handlers.
 */

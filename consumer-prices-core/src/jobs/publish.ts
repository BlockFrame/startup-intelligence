/**
 * Publish job: builds compact StartupIntelligence snapshot payloads and writes to Redis.
 * Runs as an independent Railway cron service (02:30 UTC daily) after aggregate.
 * This is the handoff point between consumer-prices-core and StartupIntelligence.
 */
import {
...
} from '../snapshots/startup_intelligence.js';

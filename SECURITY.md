...
If you discover a security vulnerability in Startup Intelligence, please report it responsibly:

1. **GitHub Private Vulnerability Reporting**: Use [GitHub's private vulnerability reporting](https://github.com/koala73/startup-intelligence/security/advisories/new) to submit your report directly through the repository.
...
Startup Intelligence is a client-side intelligence dashboard that aggregates publicly available data. Here are the key security areas:
...
- Startup Intelligence aggregates publicly available OSINT data
...
- Vulnerabilities in the Startup Intelligence codebase
...
Thank you for helping keep Startup Intelligence and its users safe! 🔒

...
function makeGetRequest(params = {}, origin = 'https://startupintelligence.app') {
  const url = new URL('https://startupintelligence.app/api/mcp-proxy');
...
function makePostRequest(body = {}, origin = 'https://startupintelligence.app') {
  return new Request('https://startupintelligence.app/api/mcp-proxy', {
    method: 'POST',
...
function makeOptionsRequest(origin = 'https://startupintelligence.app') {
  return new Request('https://startupintelligence.app/api/mcp-proxy', {
    method: 'OPTIONS',
    headers: { origin },
  });
...
describe('api/mcp-proxy', () => {
  ...
  describe('CORS and method handling', () => {
    ...
    it('returns 405 for DELETE', async () => {
      const res = await handler(new Request('https://startupintelligence.app/api/mcp-proxy', {
        method: 'DELETE',
  ...
  describe('GET /api/mcp-proxy (list tools)', () => {
    ...
    it('ignores invalid JSON in headers param', async () => {
      ...
      const req = new Request(url.toString(), { method: 'GET', headers: { origin: 'https://startupintelligence.app' } });

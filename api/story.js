...
export default function handler(req, res) {
  const url = new URL(req.url, 'https://startupintelligence.app');
  ...
  const baseUrl = 'https://startupintelligence.app';
  ...
  const title = `${countryName} Intelligence Brief | Startup Intelligence`;
...
<head>
  ...
  <meta property="og:site_name" content="Startup Intelligence"/>

  <meta name="twitter:card" content="summary_large_image"/>
  <meta name="twitter:site" content="@StartupIntelligenceApp"/>

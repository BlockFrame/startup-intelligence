...
// Source of truth: server/startup_intelligence/resilience/v1/_shared.ts
...
try {
  const mod = await import('../server/startup_intelligence/resilience/v1/_dimension-scorers.ts');

...
const SERVICE_UA = 'startupintelligence-llm/1.0';
...
const LLM_PROVIDERS = [
  ...
  },
  {
    ...
    headers: (key) => ({ 'Authorization': `Bearer ${key}`, 'Content-Type': 'application/json', 'HTTP-Referer': 'https://startupintelligence.app', 'X-Title': 'Startup Intelligence', 'User-Agent': SERVICE_UA }),
    timeout: 20_000,
  },
];

...
const VARIANT_HOST_MAP: Record<string, string> = {
  'tech.startupintelligence.app': 'tech',
  'finance.startupintelligence.app': 'finance',
  'commodity.startupintelligence.app': 'commodity',
  'happy.startupintelligence.app': 'happy',
};
...
const VARIANT_OG: Record<string, { title: string; description: string; image: string; url: string }> = {
  tech: {
    ...
    image: 'https://tech.startupintelligence.app/favico/tech/og-image.png',
    url: 'https://tech.startupintelligence.app/',
  },
  finance: {
    title: 'Finance Monitor - Real-Time Markets & Trading Dashboard',
    description: 'Real-time finance and trading dashboard tracking global markets, stock exchanges, central banks, commodities, forex, crypto, and economic indicators worldwide.',
    image: 'https://finance.startupintelligence.app/favico/finance/og-image.png',
    url: 'https://finance.startupintelligence.app/',
  },
  commodity: {
    ...
    image: 'https://commodity.startupintelligence.app/favico/commodity/og-image.png',
    url: 'https://commodity.startupintelligence.app/',
  },
  happy: {
    ...
    image: 'https://happy.startupintelligence.app/favico/happy/og-image.png',
    url: 'https://happy.startupintelligence.app/',
  },
};
